...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f6fbf7] text-slate-900 bg-medical-subtle">
      ...
      <section className="relative min-h-[680px] overflow-hidden bg-white">
        ...
        <div className="relative mx-auto flex min-h-[680px] max-w-7xl items-center px-6 py-20 md:px-10">
          ...
          <div className="max-w-[570px]">
            ...
            {/* Main heading */}
            <h1 className="text-5xl font-extrabold leading-[1.08] tracking-tight text-slate-900 sm:text-6xl lg:text-[64px]">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <a
                href="#how-it-works"
                className="inline-flex min-h-[54px] items-center rounded-xl border border-green-200 bg-white/90 px-7 py-3.5 font-semibold text-slate-700 shadow-sm backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-green-300 hover:text-green-700"
              >
                How it works
              </a>
            ...
            {/* Small product card */}
            <div className="mt-10 flex max-w-md items-center gap-4 rounded-2xl border border-green-100 bg-white/90 p-4 shadow-lg backdrop-blur">
        ...
        <div className="absolute bottom-8 right-8 hidden rounded-2xl border border-green-100 bg-white/90 px-5 py-4 shadow-xl backdrop-blur lg:block">
      ...
      <section
        id="how-it-works"
        className="bg-[#f6fbf7] px-6 py-20 md:px-10"
      >
      ...
      <section className="bg-white px-6 py-20 md:px-10">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          ...
          <div className="rounded-3xl border border-green-100 bg-[#f6fbf7] p-5 shadow-sm">
      ...
      {/* =====================================================
          FAQ
      ====================================================== */}
      <section className="bg-[#f6fbf7] px-6 py-20 md:px-10">
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex min-h-[64px] w-full items-center justify-between gap-4 px-5 py-4 text-left font-semibold text-slate-800 transition hover:text-green-700"
                  >

                    <span>{faq.question}</span>

                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-green-50 text-xl text-green-600">
                      {isOpen ? "−" : "+"}
                    </span>
                  ...
                  {isOpen && (
                    <div className="border-t border-green-50 px-5 pb-5 pt-4 text-sm leading-7 text-slate-600">
                      {faq.answer}
                    </div>
                  )}
      ...
      {/* =====================================================
          FOOTER / DISCLAIMER
      ====================================================== */}
      <footer className="border-t border-green-100 bg-white px-6 py-12 md:px-10">

        <div className="mx-auto max-w-6xl text-center">

          <div className="mx-auto flex h-11 w-11 items-center justify-center rounded-full bg-amber-100 font-bold text-amber-700">
            !
          </div>
...
function ProcessContent({
  ...
  return (
    <div className="flex flex-col gap-7 md:flex-row md:items-center">
      ...
      <div className="flex h-24 w-24 shrink-0 items-center justify-center rounded-3xl bg-green-100 text-3xl font-bold text-green-700">
        {icon}
      </div>
