...
export async function POST(request) {
  try {
    ...
    // Gemini can natively read PDFs, including scanned documents and PDFs with
    // malformed cross-reference tables that local text extractors may reject.
    // Only extract local text for non-PDF files.
    let reportText = "";
